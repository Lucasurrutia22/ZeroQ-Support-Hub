    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
        >
          Descargar
        </a>
