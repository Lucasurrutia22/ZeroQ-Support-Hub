...
// aprobado/creado (AI_RAG_DESIGN.md §1) sin que Knowledge dependa de
...
// nunca debe bloquear la aprobación de un procedimiento (AI_RAG_DESIGN.md
// §1: "una aprobación no debe esperar la latencia de embeddings"). El
// adapter es responsable de capturar sus propios errores; un fallo de
// indexación nunca debe propagarse como fallo del use case que la disparó.
export type IndexableSourceType = "procedure_version";
